...
export default function Programmers() {
  ...
  const [featProgrammer, setFeatProgrammer] = useState(0)
  ...
  const getNameOfFeatured = () => {
    ...
    return programmers[featProgrammer - 1].name;
  };

  const style = {
    fontSize: '1.5em',
    marginTop: '0.5em',
    color: featProgrammer ? 'gold' : 'royalblue', // 🤔 color turns to gold, when celebrating
  };
